...
#
  ...
  # Create - Questions
  Question.create(
  quiz_id: Quiz.first.id, description: "Voce pode tosar e/ou escovar o seu cachorro com que frequencia?", photourl: "https://images.unsplash.com/photo-1527526029430-319f10814151?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2370&q=80")
  # true == >= 5 (grooming_frequency_value)
  Question.create(
  quiz_id: Quiz.first.id, description: "Troca de pelo frequente de incomoda?", photourl: "https://photos.smugmug.com/photos/i-QKBF4L6/0/4K/i-QKBF4L6-4K.jpg")
  ...
  Question.create(
  quiz_id: Quiz.first.id,  description: "É muito importante pra voce que o cachorro se adapte bem com outros cachorros e pessoas fora do circulo familar?", photourl: "https://images.pexels.com/photos/4588015/pexels-photo-4588015.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")
  ...
  # true == size == pequeno)
  Question.create(
  quiz_id: Quiz.first.id,  description: "Voce gostaria de ter uma raca media?", photourl:"https://photos.smugmug.com/photos/i-FQVNFKF/0/4K/i-FQVNFKF-4K.jpg" )
  # true == size == medio
  Question.create(
